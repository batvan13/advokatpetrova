...
class ViberConsultationGoogleBusyTest extends TestCase
{
    ...
    public function test_viber_slots_returns_fail_closed_json_when_google_calendar_unavailable(): void
    {
        ...
        $response = $this->getJson('/consultation/viber/slots?date=2026-06-11&duration=30');
    ...
    public function test_viber_slots_excludes_google_busy_interval(): void
    {
        Carbon::setTestNow(Carbon::parse('2026-06-10 12:00:00', 'Europe/Sofia'));
