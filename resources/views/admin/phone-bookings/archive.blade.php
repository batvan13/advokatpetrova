...
@section('title', 'Архив — Телефонни консултации — Admin')

@section('content')

    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-xl font-semibold text-gray-900">Архив — Телефонни консултации</h1>
            <p class="mt-1 text-sm text-gray-500">Архивирани телефонни консултации.</p>
        </div>
    ...
    @if ($bookings->isEmpty())
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm px-8 py-16 text-center">
            ...
            <p class="text-sm text-gray-400">Все още няма архивирани телефонни консултации.</p>
        </div>
    @else
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-4 text-right">
                                <div class="inline-flex items-center gap-2">
                                    ...
                                    <form action="{{ route('admin.phone-bookings.destroy', $booking) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                                class="text-xs px-3 py-1.5 rounded border border-gray-200
