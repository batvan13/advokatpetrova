...
@section('title', 'Редакция на администратор — Admin')

@section('content')

    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-xl font-semibold text-gray-900">Редакция на администратор</h1>
            <p class="mt-1 text-sm text-gray-500">{{ $admin->name }}</p>
        </div>
    ...
    <form action="{{ route('admin.admins.update', $admin) }}" method="POST" novalidate>
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm divide-y divide-gray-100">
            ...
            <div class="px-8 py-6 space-y-5">
                <p class="text-xs font-bold tracking-widest uppercase text-gray-400">Смяна на парола</p>
                <p class="text-xs text-gray-400">Остави празно, ако не искаш да сменяш паролата.</p>
