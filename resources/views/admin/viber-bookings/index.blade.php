            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-gray-100">
                        ...
                        <th class="px-5 py-3 text-left text-xs font-semibold text-gray-400 uppercase tracking-wider">Продълж.</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    @foreach ($bookings as $booking)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-4 text-gray-600">{{ $booking->duration_minutes }} мин.</td>
